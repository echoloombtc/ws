...
echo ""
wget -q https://raw.githubusercontent.com/kenDevXD/ws/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget -O ssh-vpn.sh https://raw.githubusercontent.com/kenDevXD/multi/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Install Xray
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget -O ins-xray.sh https://raw.githubusercontent.com/kenDevXD/ws/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
#Set Backup
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/kenDevXD/ws/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
sleep 2
clear
wget -O insshws.sh https://raw.githubusercontent.com/kenDevXD/ws/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
#Install SSH Websocket
echo -e "${tyblue}.------------------------------------------.${NC}"
...
echo -e "${tyblue}'------------------------------------------'${NC}"
sleep 2
wget -O update.sh https://raw.githubusercontent.com/kenDevXD/ws/main/update/update.sh && chmod +x update.sh && ./update.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
if [ "$BASH" ]; then
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/kenDevXD/ws/main/version  )
